...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.layer3 = self._make_layer(block, 256, num_blocks[2], stride=1, dilation=1)
        self.layer4 = self._make_layer(block, 512, num_blocks[3], stride=1, dilation=1)
    ...
    def forward(self, x):
        ...
        c3 = self.layer3(c2)
        c4 = self.layer4(c3)
        out = F.adaptive_avg_pool2d(c4, 1)
    ...
    def forward_cam(self, x):
        ...
        out = F.conv2d(c4, self.linear.weight[:, :, None, None])
